...
// .trim() guards against a trailing newline/space sneaking into the env var value when it's
// pasted into a dashboard (e.g. Render's Environment tab) — a real incident, not hypothetical:
// this exact whitespace mismatch caused every login to fail with "Wrong recipient, payload
// audience != requiredAudience" even though the two values looked identical when printed.
